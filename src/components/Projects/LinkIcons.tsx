...
const LinkIcons: FC<ILinkIconsProps> = ({ href, codeLink }) => (
  <div className="absolute opacity-0 inset-0 flex items-center justify-center gap-4 group-hover:opacity-100 group-focus:opacity-100  transition ease-out duration-300 z-10 hover:bg-addGray backdrop-blur-sm  focus:bg-addGray hover:dark:bg-addGray focus:dark:bg-addGray ">
    {" "}
