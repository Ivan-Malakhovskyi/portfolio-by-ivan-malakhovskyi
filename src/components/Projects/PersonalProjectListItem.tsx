...
const PersonalProjectListItem: FC<ProjectsListItemProps> = ({ project }) => {
  ...
  return (
    <div
      key={id}
      className="grid grid-cols-1 items-center md:grid-cols-2 gap-6 max-w-[1712px]  bg-gray-900 shadow-lg rounded-lg p-8 w-full hover:scale-95 transition ease-out duration-300"
      ref={ref}
    >
      <motion.div
