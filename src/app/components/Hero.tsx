...
const Hero: FC = () => {
  return (
    <MaxWidthWrapper className="hero bg-gradient-to-r from-mainBlack to-slate-500 animate-gradient-xy">
      <section className="py-14">
        ...
        <div className="max-w-4xl">
          ...
          <Link
            ...
            className="text-mainBlack bg-mainGreen px-12 py-4 rounded-full hover:bg-addGreen focus:bg-addGreen transition ease-out duration-300 mr-10"
          >
            Hire me
          </Link>
